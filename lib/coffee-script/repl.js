...
(function() {
  var CoffeeScript, EOL, addHistory, addMultilineHandler, fs, getCommandId, merge, nodeLineListener, nodeREPL, path, promptData, ref, replDefaults, runInContext, updateSyntaxError, vm;
  ...
  module.exports = {
    start: function(opts) {
      ...
      repl.commands[getCommandId(repl, 'load')].action = function(file) {
        var data, e, stats;
        try {
